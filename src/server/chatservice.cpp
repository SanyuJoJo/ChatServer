...
_msgHandlerMap.insert({REG_MSG_ACK,std::bind(&ChatService::reg,this,_1,_2,_3)});
_msgHandlerMap.insert({ONE_CHAT_ACK,std::bind(&ChatService::oneChat,this,_1,_2,_3)});
